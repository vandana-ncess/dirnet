  ...
  $.Calendario.prototype = {
    ...
    _propDate: function($cell, event){
      ...
      $cell.children( 'div.fc-calendar-events').children('div.fc-calendar-event').each(function(i, e){
        var $html = $('<div style="background-color:red;">' + $(e).html() + '</div>');
    ...
    _wrapDay: function (day, date, wrap) {
      if(date){
        ...
        else return '<div class="fc-calendar-event" style="background-color:red;">' + this._timeHtml(day, date) + '</div>';
...
var $weekend="";
      ...
      for (var i = 0; i < 7; i++){ // this loop is for weeks (rows)
        for (var j = 0; j <= 6; j++) { // this loop is for weekdays (cells)
          var pos = this.startingDay - this.options.startIn,
              ...
              content = '';
              if((this.options.weekabbrs[j]=='Sun' || this.options.weekabbrs[j]=='Sat') && (day <= monthLength) && (j >= p || i > 0))
                  $weekend = "style = 'background-color:#F59595;'";
              else
                  $weekend = '';
          ...
          if (day <= monthLength && (i > 0 || j >= p)){
            ...
            if(content !== '') inner += '<div class="fc-calendar-events" style="background-color:red;">' + content + '</div>';
            ++day;
          } else {
            today = false;
          ...
          if($ind<0)
            html += (cellClasses !== '' ? '<div class="' + cellClasses.trim() + '" ' + $weekend + '>' : '<div>') + inner + '</div>';
          else 
            html +=  '<div class="' + cellClasses.trim() + '" style="background-color:#F59595; font-color:white;" >'+ inner +'</div>';
        }
      ...
      return html + '</div><img src="images/index.png" /> </div>';
    },
